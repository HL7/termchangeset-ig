Instance: SNOMEDCTChangeSetInactiveDesignationExample
...
* description = "Example of SNOMED CT Change Set including an update to the 126785002 Neoplasm of oral part of tongue (disorder) concept"
...
* property[=].type = #boolean
* concept[+].id = "2b54565d-68c9-4389-bf30-2ab0d6026ac3"
* concept[=].code = #126785002
* concept[=].extension[OWLExpression].valueString = "EquivalentClasses(:126785002 |Neoplasm of oral part of tongue (disorder)|ObjectIntersectionOf(:64572001 |Disease (disorder)|ObjectSomeValuesFrom(:609096000 |Role group (attribute)|ObjectIntersectionOf(ObjectSomeValuesFrom(:116676008 |Associated morphology (attribute)|:108369006 |Neoplasm (morphologic abnormality)|)ObjectSomeValuesFrom(:363698007 |Finding site (attribute)|:61344008 |Structure of oral part of tongue (body structure)|)))))"
* concept[=].display = "Neoplasm of oral part of tongue (disorder)"
* concept[=].definition = "Neoplasm of oral part of tongue (disorder)"
...
* concept[=].designation[=].value = "Neoplasm of oral part of tongue (disorder)"
...
* concept[=].designation[=].value = "Neoplasm of oral part of tongue"
...
* concept[=].designation[=].extension[caseSensitivity].valueCodeableConcept.coding.display = "Only initial character case insensitive (core metadata concept)"
* concept[=].designation[=].extension[acceptability].url = "http://hl7.org/fhir/uv/termchangeset/StructureDefinition/designation-acceptability"
* concept[=].designation[=].extension[acceptability].valueCodeableConcept.coding.code = #900000000000549004
* concept[=].designation[=].extension[acceptability].valueCodeableConcept.coding.system = "http://snomed.info/sct"
* concept[=].designation[=].extension[acceptability].valueCodeableConcept.coding.display = "Acceptable (foundation metadata concept)"
* concept[=].designation[=].extension[dialect].url = "http://hl7.org/fhir/uv/termchangeset/StructureDefinition/designation-dialect"
* concept[=].designation[=].extension[dialect].valueCodeableConcept.coding.code = #900000000000509007
* concept[=].designation[=].extension[dialect].valueCodeableConcept.coding.system = "http://snomed.info/sct"
* concept[=].designation[=].extension[dialect].valueCodeableConcept.coding.display = "United States of America English language reference set"
...
* concept[=].designation[=].use[=].code = #900000000000013009
* concept[=].designation[=].use[=].display = "Synonym"
* concept[=].designation[=].value = "Neoplasm of anterior two-thirds of tongue"
...
* concept[=].designation[=].use[=].code = #900000000000013009
* concept[=].designation[=].use[=].display = "Synonym"
* concept[=].designation[=].value = "Neoplasm of body of tongue"
...
* concept[=].designation[=].use[=].code = #900000000000013009
* concept[=].designation[=].use[=].display = "Synonym"
* concept[=].designation[=].value = "Tumor of anterior two-thirds of tongue"
...
* concept[=].designation[=].extension[acceptability].valueCodeableConcept.coding.code = #900000000000548007
* concept[=].designation[=].extension[acceptability].valueCodeableConcept.coding.system = "http://snomed.info/sct"
* concept[=].designation[=].extension[acceptability].valueCodeableConcept.coding.display = "Not Acceptable (foundation metadata concept)"
* concept[=].designation[=].extension[dialect].url = "http://hl7.org/fhir/uv/termchangeset/StructureDefinition/designation-dialect"
* concept[=].designation[=].extension[dialect].valueCodeableConcept.coding.code = #900000000000509007
* concept[=].designation[=].extension[dialect].valueCodeableConcept.coding.system = "http://snomed.info/sct"
* concept[=].designation[=].extension[dialect].valueCodeableConcept.coding.display = "United States of America English language reference set"
* concept[=].designation[=].modifierExtension[designationStatus].extension[active].valueBoolean = false
* concept[=].designation[=].modifierExtension[designationStatus].extension[effectiveTime].valueDateTime = "2025-07-08T10:00:00Z"
* concept[=].designation[=].use[+].system = "http://snomed.info/sct"
* concept[=].designation[=].use[=].code = #900000000000003001
* concept[=].designation[=].use[=].display = "Fully specified name"
* concept[=].designation[=].value = "Neoplasm of anterior two-thirds of tongue (disorder)"

* concept[=].property[+].code = #"Is a"
...
* concept[=].property[=].extension[roleGroup].valueInteger = 0
* concept[=].property[=].valueCoding[+].system = "http://snomed.info/sct"
* concept[=].property[=].valueCoding[=].code = #126778001
* concept[=].property[=].valueCoding[=].display = "Neoplasm of tongue (disorder)"
...
* concept[=].property[=].valueCoding[+].system = "http://snomed.info/sct"
* concept[=].property[=].valueCoding[=].code = #61344008
* concept[=].property[=].valueCoding[=].display = "Structure of oral part of tongue (body structure)"

* concept[=].property[+].code = #"Associated morphology"
* concept[=].property[=].extension[DefiningRelationshipType].url = "http://hl7.org/fhir/uv/termchangeset/StructureDefinition/defining-relationship-type"
* concept[=].property[=].extension[DefiningRelationshipType].valueCodeableConcept.coding.code = #900000000000010007
* concept[=].property[=].extension[DefiningRelationshipType].valueCodeableConcept.coding.system = "http://snomed.info/sct"
* concept[=].property[=].extension[DefiningRelationshipType].valueCodeableConcept.coding.display = "Stated relationship (core metadata concept)"
...
* concept[=].property[=].valueCoding[+].system = "http://snomed.info/sct"
* concept[=].property[=].valueCoding[=].code = #108369006
* concept[=].property[=].valueCoding[=].display = "Neoplasm (morphologic abnormality)"
